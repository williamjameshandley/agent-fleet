...
def muster():
    ...
    command = [
        ...
        "--bind=enter:execute-silent(/usr/lib/agent-fleet/fleet-open main {1})",
        "--bind=left-click:execute-silent(/usr/lib/agent-fleet/fleet-open main {1})",
        "--bind=double-click:execute-silent(/usr/lib/agent-fleet/fleet-open main {1})",
