...
license=('MIT')
options=('!debug')
depends=('alan>=1:2.0.0.a11.r1785279801.gddf433c' python python-libtmux python-watchfiles jupyter-console openai-codex tmux fzf openssh curl procps-ng libvterm)
optdepends=(
