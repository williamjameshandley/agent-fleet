...
license=('MIT')
options=('!debug')
depends=('alan>=1:2.0.0.a11.r1785282507.gee53cbf' python python-libtmux python-watchfiles jupyter-console openai-codex tmux fzf openssh curl procps-ng libvterm)
optdepends=(
