...
license=('MIT')
options=('!debug')
depends=('alan-tui' python python-systemd python-libtmux python-watchfiles jupyter-console openai-codex tmux fzf openssh openbsd-netcat curl procps-ng inetutils libvterm)
optdepends=(
